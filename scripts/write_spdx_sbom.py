...
def main() -> int:
    ...
    document = {
        ...
        "name": f"pleiades-factory-stack-termux-{args.version}",
        "documentNamespace": f"https://github.com/Zheke32174/pleiades-factory-stack-termux/sbom/{commit}",
        "creationInfo": {"created": created, "creators": ["Tool: scripts/write_spdx_sbom.py"]},
        "packages": [{
            "name": "pleiades-factory-stack-termux",
            ...
            "externalRefs": [{
                ...
                "referenceType": "purl",
                "referenceLocator": f"pkg:github/Zheke32174/pleiades-factory-stack-termux@{commit}",
            }],
        }],
        "files": files,
